        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
          ...
          >
            ...
            <p className="mt-4 text-lg text-gray-500">
              We're building the next generation of digital tools designed to make your life easier, more productive, and more enjoyable.
            </p>
            <div className="mt-6">
              <div className="text-base text-gray-500 space-y-4">
                <p>Founded in 2023, our team of experts brings decades of combined experience in crafting intuitive, powerful software solutions.</p>
                <p>We believe technology should work for people, not the other way around. That's why we've designed our product with real humans in mind, focusing on what matters most: your experience and success.</p>
              </div>
            </div>
            <div className="mt-8">
              <Button

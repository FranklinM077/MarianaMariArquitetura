          ...
          <div className="pt-10 sm:pt-16 lg:pt-8 lg:pb-14 px-4 sm:px-6 lg:px-8">
            ...
            >
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block xl:inline">Criando espaços que</span>{" "}
                <span className="block text-primary xl:inline">inspiram e transformam</span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                Soluções arquitetônicas personalizadas para residências, comércios e espaços corporativos. 
                Combinando estética, funcionalidade e sustentabilidade.
              </p>
